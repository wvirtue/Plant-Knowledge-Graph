...
from utils import test_input, train

# func_testify.txt func_extract.txt

with open('../data/plantdata.pkl', 'rb') as inp:
...
if len(sys.argv)==2 and sys.argv[1]=="pretrained":
    ...
    word2vec = {}
    with codecs.open('plant_word2vec.txt','r','utf-8') as input_data:
