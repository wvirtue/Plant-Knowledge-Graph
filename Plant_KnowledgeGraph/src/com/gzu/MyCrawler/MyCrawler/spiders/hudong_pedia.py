...
from src.com.gzu.MyCrawler.MyCrawler.items import HudongItem
...
#	file_object = open('merge_table3.txt','r').read()
	file_object = open('E:\学习\毕业论文文献及项目\项目\Plant_KnowledgeGraph\src\com\gzu\wikidataSpider\wikientities\iplant_entity.txt','r',encoding='utf-8').read()
...
#	start_urls.append('http://www.baike.com/wiki/李%5B蔷薇科李属植物%5D')
  ...
  # 本处是用于构造原始json 长颖鹅观草
	# start_urls=["http://www.baike.com/wiki/长颖鹅观草"]
