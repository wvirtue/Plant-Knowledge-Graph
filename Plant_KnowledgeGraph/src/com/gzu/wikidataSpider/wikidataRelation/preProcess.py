...
resultJsonFile = codecs.open('./data/readytoCrawl.json','w',encoding = 'utf-8') ;
with open("E:\学习\毕业论文文献及项目\项目\Plant_KnowledgeGraph\src\com\gzu\wikidataSpider\wikientities\wikientities\entities.json","r",encoding='utf8') as fr:
